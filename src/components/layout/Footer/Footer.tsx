...
const SOCIALS = [
	...
	{
		label: 'Instagram',
		href: 'https://www.instagram.com/annur.kg_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
		icon: (
			<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
			...
			<div className="footer__inner">
				<div className="footer__top">
					<div className="footer__brand">
						...
						<div className="footer__contacts">
							...
							<a href="mailto:annur@gmail.com" className="footer__contact-link">
								<svg
									width="13"
									height="13"
									viewBox="0 0 24 24"
				...
				<div className="footer__map-section">
					...
					<div className="footer__map-wrapper">
						<iframe
							...
							frameBorder="0"
							allowFullScreen
							title="ANNUR на карте — ул. Абдумомунова 249, Бишкек"
				...
				<div className="footer__bottom">
					...
					<p className="footer__made">
						Сделано с&nbsp;<span aria-label="любовью">♥</span>&nbsp; Restoran
						ANNUR
					</p>
				</div>
			</div>
